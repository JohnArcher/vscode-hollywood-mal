...
export class HollywoodDefinitionProvider implements vscode.DefinitionProvider {
        ...
        Thenable<vscode.Definition>{
            return new Promise((resolve, reject) => {
                ...
                if (vscode.workspace.name) {
                    ...
                    const workspaceFiles = vscode.workspace.findFiles('**/*.hws');

                    workspaceFiles.then(
                        (uriList) => {

                            // List of all promises for finding and getting the definition in all opened documents
                            let definitionPromises: Thenable<vscode.Definition>[] = [];
    ...
    private getDefinitions(document: vscode.TextDocument, selectedWord: string): vscode.Definition {
